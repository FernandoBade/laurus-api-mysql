...
export default function CategoriesPage() {
  ...
  const resolveCategoryTypeLabel = (category: Category) =>
  ...
  const sortedCategories = useMemo(() => {
    ...
    return items;
  }, [filteredCategories, locale, sortDirection, sortKey, typeLabels, t]);
  ...
  const pagedCategories = useMemo(
    ...
    [currentPage, groupedCategories, pageSize]
  );
