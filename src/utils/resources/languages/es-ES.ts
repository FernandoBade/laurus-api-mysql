...
const esES: LanguageResource = {
    ...
    EMAIL_FALLBACK_LINK_LABEL: "Si el botón no funciona, copia y pega este enlace en tu navegador:",
    EMAIL_VERIFICATION_BUTTON: "Verificar correo",
    EMAIL_VERIFICATION_INTRO: "Usa el botón de abajo para verificar tu correo electrónico.",
    ...
    PASSWORD_RESET_INTRO: "Usa el botón de abajo para restablecer tu contraseña.",
