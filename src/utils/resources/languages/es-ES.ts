...
const esES: LanguageResource = {
    ...
    EMAIL_NOT_VERIFIED: "Tu cuenta existe, pero tu correo no está verificado.",
    EMAIL_VERIFICATION_BODY: "Usa el enlace de abajo para verificar tu correo electrónico.",
    EMAIL_VERIFICATION_COOLDOWN: "Espera antes de solicitar otro correo de verificación.",
    ...
    FEEDBACK_EMAIL_SUBJECT: "Comentarios de la version beta",
    FEEDBACK_EMAIL_INTRO: "Se envio un nuevo mensaje de comentarios beta.",
    FEEDBACK_EMAIL_TITLE_LABEL: "Titulo:",
    FEEDBACK_EMAIL_MESSAGE_LABEL: "Mensaje:",
    FEEDBACK_EMAIL_USER_ID_LABEL: "ID de usuario:",
    FEEDBACK_EMAIL_USER_EMAIL_LABEL: "Email de usuario:",
    FEEDBACK_SEND_FAILED: "No se pudo enviar los comentarios en este momento.",
